export const experiences = [
  ...
  
  {
    ...
    location: 'Cleveland, OH',
    description: [
      'Collaborated with researchers to analyze colony-forming assays, assessing the radiosensitizing effects of CDDO-2P-Im in DIPG cells.',
      'Authored a detailed manuscript outlining findings and proposed methodologies for future in vivo studies.'
    ]
  }
];
